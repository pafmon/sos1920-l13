...
var app = (function () {
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, contacts, newContact*/ 1027) {
    ...
    // (69:10) <Button outline  color="primary" on:click={insertContact}>
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(69:10) <Button outline  color=\\\"primary\\\" on:click={insertContact}>",
    		ctx
    	});
    ...
    // (77:10) <Button outline color="danger">
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(77:10) <Button outline color=\\\"danger\\\">",
    		ctx
    	});
    ...
    // (72:4) {#each contacts as contact}
    function create_each_block(ctx) {
    	let tr;
    	let td0;
    	let t0_value = /*contact*/ ctx[7].name + "";
    	let t0;
    	let t1;
    	let td1;
    	let t2_value = /*contact*/ ctx[7].email + "";
    	let t2;
    	let t3;
    	let td2;
    	let t4_value = /*contact*/ ctx[7].phone + "";
    	let t4;
    	let t5;
    	let td3;
    	let t6;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if ((!current || dirty & /*contacts*/ 2) && t0_value !== (t0_value = /*contact*/ ctx[7].name + "")) set_data_dev(t0, t0_value);
    			if ((!current || dirty & /*contacts*/ 2) && t2_value !== (t2_value = /*contact*/ ctx[7].email + "")) set_data_dev(t2, t2_value);
    			if ((!current || dirty & /*contacts*/ 2) && t4_value !== (t4_value = /*contact*/ ctx[7].phone + "")) set_data_dev(t4, t4_value);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(72:4) {#each contacts as contact}",
    		ctx
    	});
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<ContactsTable> was created with unknown prop '${key}'`);
    	});
    ...
    function create_fragment$3(ctx) {
    	let main;
    	let current;
    	const contactstable = new ContactsTable({ $$inline: true });
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ ContactsTable });
    	return [];
    }
